...
```bash
HIVEFORGE_IMAGE=ghcr.io/sepa79/hiveforge:v0.5.7 docker compose -f docker-compose.hiveforge.yml up -d
```
...
`ghcr.io/sepa79/hiveforge:v0.5.7`; it does not update to floating `latest`.
